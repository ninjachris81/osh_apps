package com.osh.views.dashboard;
...
@PageTitle("Dashboard")
@Route(value = "dashboard/:knownAreaID?/:action?(edit)", layout = MainLayout.class)
...
public class DashboardView extends Div implements BeforeEnterObserver {
    ...
    private final String KNOWNAREA_EDIT_ROUTE_TEMPLATE = "dashboard/%s/edit";
    ...
    public DashboardView(KnownAreaService knownAreaService) {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        Optional<Long> knownAreaId = event.getRouteParameters().get(KNOWNAREA_ID).map(Long::parseLong);
        if (knownAreaId.isPresent()) {
            Optional<KnownArea> knownAreaFromBackend = knownAreaService.get(knownArea.getId());
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        ...
        formLayout.add(name, displayOrder);
